...
func (r *Home) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Home":
		...
		case "UnitTest":
			...
			return (*Home).UnitTest(&parent, ctx, app, env)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("Home").
					WithFunction(
						dag.Function("UnitTest",
							dag.TypeDef().WithKind(StringKind)).
							WithDescription("example usage: \"dagger call unit-test --app system/cert-manager --env dev\"").
							WithArg("app", dag.TypeDef().WithObject("Directory")).
							WithArg("env", dag.TypeDef().WithKind(StringKind)))), nil
	default:
